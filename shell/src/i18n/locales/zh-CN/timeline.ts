...
export const timeline = {
  ...
  context: {
    evolution: "上下文演进",
    snapshots: "{count} 份快照",
    snapshotHistory: "快照记录",
    snapshotNumber: "快照 {count}",
    following: "正在跟随最新",
    followLatest: "回到最新",
    charDelta: "较上次 {count} 字符",
    contentView: "上下文内容视图",
    changes: "变化",
    fullContent: "完整内容",
    copy: "复制原文",
    copied: "已复制",
    copyFailed: "复制失败，请重试",
    comparedWith: "对比同类快照 {count} ·",
    initialSnapshot: "首份同类快照 ·",
    lines: "行",
    coarseDiff: "变化范围较大，中间内容按整块替换展示。",
    emptyContent: "这份记录没有可展示的内容。",
    unchanged: "与上一份同类快照内容一致。",
    longLines: "超长行已折叠显示，复制原文可获取完整内容。",
    moreLines: "继续显示（剩余 {count} 行）",
    readFiles: "本轮已读文件",
    searchFiles: "搜索文件名或路径",
    noMatchingFiles: "没有匹配的已读文件。",
    noReadFiles: "本轮暂无成功的文件读取记录。",
    moreFiles: "显示更多文件（剩余 {count} 个）",
