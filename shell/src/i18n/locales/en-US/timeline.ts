...
export const timeline = {
  ...
  context: {
    ...
    snapshotNumber: "Snapshot {count}",
    following: "Following latest",
    followLatest: "Back to latest",
    charDelta: "{count} chars since previous",
    contentView: "Context content view",
    changes: "Changes",
    fullContent: "Full content",
    copy: "Copy original",
    copied: "Copied",
    copyFailed: "Copy failed. Try again.",
    comparedWith: "Compared with snapshot {count} of the same source ·",
    initialSnapshot: "First snapshot of this source ·",
    lines: "lines",
    coarseDiff: "Large changes are shown as a replacement block in the middle.",
    emptyContent: "This record has no content to display.",
    unchanged: "Unchanged from the previous snapshot of this source.",
    longLines: "Long lines are shortened. Copy the original for complete content.",
    moreLines: "Show more ({count} lines remaining)",
    readFiles: "Files read this turn",
    searchFiles: "Search file name or path",
    noMatchingFiles: "No matching files.",
    noReadFiles: "No successful file reads in this turn yet.",
    moreFiles: "Show more files ({count} remaining)",
