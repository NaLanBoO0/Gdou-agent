...
<style>
.gdou-composer .command-picker { display: flex; flex-direction: column; max-height: min(520px, 65vh); color: var(--text, #30343a); }
...
.gdou-composer .command-picker .slash-menu__scroll { flex: 1 1 auto; min-height: 0; max-height: none; padding: 0 7px 7px; }
...
.gdou-composer .command-picker > footer { flex: none; }
