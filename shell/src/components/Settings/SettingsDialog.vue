...
const PROJECT_URL = "https://github.com/NaLanBoO0/Gdou-agent";
...
const notifications = ref(localStorage.getItem("gdou.notifications") !== "false");
...
watch(notifications, (enabled) => localStorage.setItem("gdou.notifications", String(enabled)));
                ...
                <div class="about-row">
                  ...
                  <dd>
                    <button type="button" class="link-btn" :aria-label="t('settings.about.openLink')" :title="t('settings.about.openBrowser')" @click="openProjectLink">
                      ...
                      <span>github.com/NaLanBoO0/Gdou-agent</span>
